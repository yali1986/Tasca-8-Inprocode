...
//           <div className='col d-flex justify-content-end align-items-center'>
//             <h1
//               className={`text-white me-3 ${currentWeek === 0 ? 'disabled' : ''}`}
//               onClick={() => currentWeek > 0 && changeWeek('prev')}
//             >
//               ←
//             </h1>
//             <h1
//               className={`text-white ${currentWeek === graphData.length - 1 ? 'disabled' : ''}`}
//               onClick={() => currentWeek < graphData.length - 1 && changeWeek('next')}
//             >
//               →
//             </h1>
//           </div>
